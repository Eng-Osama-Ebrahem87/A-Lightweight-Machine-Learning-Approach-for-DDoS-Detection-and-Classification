...
training_time_per_instance = training_time/ len(X_train)
print(f'Training_time = {training_time}')
print(f'Training_time_per_instance = {training_time_per_instance}')
...
prediction_time_per_instance = prediction_time / len(X_test)
print(f'prediction_time = {prediction_time}')
print(f'prediction_time_per_instance = {prediction_time_per_instance}')
